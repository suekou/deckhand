  ...
  slides: [
    ...
    },
    {
      ...
      elements: [
        ...
        element('s2-card-1', 'card', 'visual', 7, 62, 24, 24, 'Prompt', { color: ink, fill: '#f7f5ed', stroke: '#d1cfc5', strokeWidth: 1, fontSize: 26, fontWeight: 660, radius: 16, padding: 22, paddingBottom: 26 }, 'Describe every decision'),
        element('s2-line-1', 'line', 'visual', 31, 74, 6, 1, '', { stroke: '#9b9d95', strokeWidth: 2 }),
        element('s2-card-2', 'card', 'visual', 37, 62, 24, 24, 'Generate', { color: '#ffffff', fill: violet, fontSize: 26, fontWeight: 660, radius: 16, padding: 22, paddingBottom: 26 }, 'Accept a black box'),
        element('s2-line-2', 'line', 'visual', 61, 74, 6, 1, '', { stroke: '#9b9d95', strokeWidth: 2 }),
        element('s2-card-3', 'card', 'visual', 67, 62, 26, 24, 'Rebuild', { color: ink, fill: '#f7f5ed', stroke: coral, strokeWidth: 2, fontSize: 26, fontWeight: 660, radius: 16, padding: 22, paddingBottom: 26 }, 'Lose the AI context'),
    ...
    },
    {
      ...
      elements: [
        ...
        element('s3-node-1', 'card', 'visual', 60, 44, 31, 12, 'Slide', { color: '#f3f1e8', fill: '#22231f', stroke: '#454740', strokeWidth: 1, fontSize: 21, fontWeight: 650, radius: 14, padding: 18, paddingBottom: 22 }, 'Narrative + layout'),
        element('s3-node-2', 'card', 'visual', 60, 61, 31, 12, 'Element', { color: '#171815', fill: lime, fontSize: 21, fontWeight: 680, radius: 14, padding: 18, paddingBottom: 22 }, 'Role + geometry + style'),
        element('s3-node-3', 'card', 'visual', 60, 78, 31, 12, 'Selection', { color: '#ffffff', fill: violet, fontSize: 21, fontWeight: 680, radius: 14, padding: 18, paddingBottom: 22 }, 'The human’s live intent'),
    ...
    },
    {
      ...
      elements: [
        ...
        element('s4-before', 'card', 'visual', 7, 61, 34, 25, 'Everything we know about the market', { color: ink, fill: '#f9f7ef', stroke: '#d0cec5', strokeWidth: 1, fontSize: 22, fontWeight: 630, radius: 14, padding: 20, paddingBottom: 24 }, 'Long copy · tight spacing · low contrast'),
        ...
        element('s4-after', 'card', 'visual', 59, 61, 34, 25, 'One signal.\nMade visible.', { color: '#ffffff', fill: violet, fontSize: 31, fontWeight: 680, lineHeight: 1.03, radius: 14, padding: 20, paddingBottom: 24 }, '–46% copy · +32% whitespace'),
    ...
    },
    {
      ...
      elements: [
        ...
        element('s5-card-1', 'card', 'visual', 7, 65, 20, 20, 'Visual', { color: '#ffffff', fill: '#171815', fontSize: 22, fontWeight: 690, radius: 14, padding: 19, paddingBottom: 24 }, 'Direct editing'),
        element('s5-card-2', 'card', 'visual', 29, 65, 20, 20, 'Focused', { color: '#ffffff', fill: '#171815', fontSize: 22, fontWeight: 690, radius: 14, padding: 19, paddingBottom: 24 }, '8 typed tools'),
        element('s5-card-3', 'card', 'visual', 51, 65, 20, 20, 'Reversible', { color: '#ffffff', fill: '#171815', fontSize: 22, fontWeight: 690, radius: 14, padding: 19, paddingBottom: 24 }, 'Shared history'),
        element('s5-card-4', 'card', 'visual', 73, 65, 20, 20, 'Extensible', { color: '#ffffff', fill: violet, fontSize: 22, fontWeight: 690, radius: 14, padding: 19, paddingBottom: 24 }, 'Open JSON'),
