  ...
  slides: [
    ...
    },
    {
      ...
      elements: [
        ...
        element('s2-stat', 'stat', 'data', 73, 13, 20, 20, '68%', { color: ink, fill: lime, fontSize: 54, fontWeight: 720, radius: 18, textAlign: 'center', shadow: '0 16px 40px #727c3129' }, 'of teams rebuild AI output'),
    ...
    },
    {
      ...
      elements: [
        ...
        element('s5-card-2', 'card', 'visual', 29, 66, 20, 18, 'Focused', { color: '#ffffff', fill: '#171815', fontSize: 22, fontWeight: 690, radius: 14, padding: 17 }, '5 core tools'),
